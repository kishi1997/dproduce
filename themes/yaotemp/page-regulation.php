        ...
        <div class="l-container">
            <div class="p-intro__inner">
                ...
                <p class="p-intro__lead">
                    就業規則は、単に「法律を守るための書類」ではありません。会社を不当なリスクから守る「防波堤」であり、同時に社員が安心して力を発揮できる「組織の憲法」です。
                    10年以上更新されていない、あるいはネットのひな形を流用しただけの規則では、現代の複雑な労務トラブルや多様な働き方に対応できません。D・プロデュースは、数多くの紛争解決実績と最新の法務知見に基づき、貴社のビジョンを反映した「生きた就業規則」をプロデュースします。
                </p>
            </div>
        </div>
    </section>
