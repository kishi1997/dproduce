...
<div class="p-reason">
    ...
    <section class="p-service">
        <div class="l-container">
            ...
            <div class="p-service__tab-area">

                <ul class="p-service__tab-list js-tab-list">
                    <li class="p-service__tab-item is-active" data-tab="tab-outsourcing">
                        <button class="p-service__tab-btn">基幹・アウトソーシング</button>
                    </li>
                    <li class="p-service__tab-item" data-tab="tab-consulting">
                        <button class="p-service__tab-btn">組織改善<span class="u-hidden-sm">・</span><br
                                class="u-visible-sm" />コンサルティング</button>
                    </li>
                    <li class="p-service__tab-item" data-tab="tab-education">
                        <button class="p-service__tab-btn">戦略・教育</button>
                    </li>
                </ul>

                <div class="p-service__panel-wrapper">

                    <div class="p-service__panel is-active" id="tab-outsourcing">
                        <div class="p-service__card-list">

                            <!-- カード1 -->
                            <a href="<?php echo esc_url( home_url( '/service/startup/' ) ); ?>" class="p-service__card">
                                <div class="p-service__card-head">
                                    <span class="p-service__card-dot"></span>
                                    <h3 class="p-service__card-title">創業支援パック</h3>
                                </div>
                                <p class="p-service__card-text">
                                    スタートアップの足場を固める。法人設立時に必要な社会保険手続きから、助成金の活用提案、労働環境の整備まで、事業立ち上げ期に必要な労務をワンストップで支援します。</p>
                                <span class="p-service__card-arrow"></span>
                            </a>

                            <!-- カード2 -->
                            <a href="<?php echo esc_url( home_url( '/service/disability-pension/' ) ); ?>"
                                class="p-service__card">
                                <div class="p-service__card-head">
                                    <span class="p-service__card-dot"></span>
                                    <h3 class="p-service__card-title">障害年金サポート</h3>
                                </div>
                                <p class="p-service__card-text">
                            ...
                            <!-- カード3 -->
                            <a href="<?php echo esc_url( home_url( '/service/payroll/' ) ); ?>" class="p-service__card">
                                <div class="p-service__card-head">
                                    <span class="p-service__card-dot"></span>
                                    <h3 class="p-service__card-title">給与計算代行</h3>
                                </div>
                                <p class="p-service__card-text">
                            ...
                            <a href="<?php echo esc_url( home_url( '/service/social-insurance/' ) ); ?>"
                                ...
                                <div class="p-service__card-head">
                                    <span class="p-service__card-dot"></span>
                                    <h3 class="p-service__card-title">労働・社会保険事務代行</h3>
                                </div>
                                <p class="p-service__card-text">
                    ...
                    <div class="p-service__panel" id="tab-consulting">
                        <div class="p-service__card-list">

                            <!-- カード1：就業規則サポート -->
                            <a href="<?php bloginfo('url'); ?>/works/" class="p-service__card">
                                <div class="p-service__card-head">
                                    <span class="p-service__card-dot"></span>
                                    <h3 class="p-service__card-title">就業規則サポート</h3>
                                </div>
                                <p class="p-service__card-text">
                            ...
                            <a href="<?php bloginfo('url'); ?>/works/" class="p-service__card">
                                <div class="p-service__card-head">
                                    <span class="p-service__card-dot"></span>
                                    <h3 class="p-service__card-title">人事評価制度構築</h3>
                                </div>
                                <p class="p-service__card-text">
                            ...
                            <a href="<?php bloginfo('url'); ?>/works/" class="p-service__card">
                                <div class="p-service__card-head">
                                    <span class="p-service__card-dot"></span>
                                    <h3 class="p-service__card-title">労務トラブル相談</h3>
                                </div>
                                <p class="p-service__card-text">
                            ...
                            <a href="<?php bloginfo('url'); ?>/works/" class="p-service__card">
                                <div class="p-service__card-head">
                                    <span class="p-service__card-dot"></span>
                                    <h3 class="p-service__card-title">SRS診断（職場環境診断）</h3>
                                </div>
                                <p class="p-service__card-text">
                    ...
                    <div class="p-service__panel" id="tab-education">
                        <div class="p-service__card-list">
                            <!-- カード5：労務監査・労務DD -->
                            <a href="<?php bloginfo('url'); ?>/works/" class="p-service__card">
                                <div class="p-service__card-head">
                                    <span class="p-service__card-dot"></span>
                                    <h3 class="p-service__card-title">労務監査<br>労務DD(デューデリジェンス)</h3>
                                </div>
                                <p class="p-service__card-text">
                            ...
                            <a href="<?php bloginfo('url'); ?>/works/" class="p-service__card">
                                <div class="p-service__card-head">
                                    <span class="p-service__card-dot"></span>
                                    <h3 class="p-service__card-title">社員研修</h3>
                                </div>
                                <p class="p-service__card-text">
                            ...
                            <a href="<?php bloginfo('url'); ?>/works/" class="p-service__card">
                                <div class="p-service__card-head">
                                    <span class="p-service__card-dot"></span>
                                    <h3 class="p-service__card-title">企業拠出年金</h3>
                                </div>
                                <p class="p-service__card-text">
