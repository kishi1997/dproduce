<?php get_header(); ?>
<div class="p-disability-pension">
    <!-- 下層ページMV -->
    <section class="p-page-header">
        <div class="p-page-header__inner">
            <span class="p-page-header__subtitle">Disability Pension</span>
        ...
        <div class="l-container">
            <div class="p-intro__inner">
                ...
                <p class="p-intro__lead">
                    病気やケガのために働くことが難しくなり、将来の生活に不安を感じていませんか？ 障害年金は、そのような方々の生活を支えるための公的な制度ですが、申請手続きは非常に複雑で、専門的な知識が求められます。「自分は対象になるのか？」「どう書類を揃えればいいのか？」と一人で悩む必要はありません。D・プロデュースは、受給の可能性を最大限に高めるパートナーとして、あなたの新しい一歩を全力でサポートします。
                </p>
            </div>
        </div>
    </section>
            ...
            <div class="p-trouble__inner">
                ...
                <ul class="p-trouble__list">
                    <li class="p-trouble__item">
                        ...
                        <p class="p-trouble__text">障害年金の対象になるのか分からない</p>
                    </li>
                    <li class="p-trouble__item">
                        <div class="p-trouble__bullet"></div>
                        <p class="p-trouble__text">手続きが複雑で何から始めればよいか不安</p>
                    </li>
                    <li class="p-trouble__item">
                        <div class="p-trouble__bullet"></div>
                        <p class="p-trouble__text">以前に申請して不支給だった</p>
                    </li>
                    <li class="p-trouble__item">
                        <div class="p-trouble__bullet"></div>
                        <p class="p-trouble__text">医師への診断書依頼の進め方が分からない</p>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <section class="p-strength">
        <div class="l-container">
            ...
            <div class="c-section-heading">
                ...
                <h2 class="c-section-heading__title-ja">/ D・プロデュースの障害年金サポート<br />３つの特長</h2>
            </div>
            ...
            <div class="p-strength__list">
                ...
                <div class="p-strength__item">
                    <figure class="p-strength__img">
                        <img src="<?php bloginfo('template_url');?>/img/consultant-img1.jpg" alt="サポートのイメージ">
                    </figure>
                    <div class="p-strength__content">
                        <div class="p-strength__head">
                            ...
                            <h3 class="p-strength__item-title">複雑な「初診日調査」を徹底サポート</h3>
                        ...
                        <p class="p-strength__desc">
                            障害年金の申請において最大の壁となるのが、その病気やケガで初めて医師の診察を受けた「初診日」の証明です。カルテが廃棄されていたり、病院が廃院していたりする場合でも、私たちはこれまでのノウハウを駆使して客観的な証拠を収集。困難なケースでも初診日の特定を粘り強くサポートします。
                        </p>
                    </div>
                </div>
                ...
                <div class="p-strength__item p-strength__item--reverse">
                    <figure class="p-strength__img">
                        <img src="<?php bloginfo('template_url');?>/img/about-why-img3.jpg" alt="書類作成のイメージ">
                    </figure>
                    <div class="p-strength__content">
                        <div class="p-strength__head">
                            <div class="p-strength__label-wrap">
                            ...
                            <h3 class="p-strength__item-title">病状を的確に伝える「申立書」作成</h3>
                        ...
                        <p class="p-strength__desc">
                            審査において医師の診断書と並んで重要なのが、ご自身の日常生活の困りごとをまとめる「病歴・就労状況等申立書」です。私たちはご本人やご家族から丁寧にヒアリングを行い、診断書だけでは伝わりきらない「真の苦しみ」や「生活の制約」を、審査官に正確に伝わる言葉で文書化します。
                        </p>
                    </div>
                </div>
                ...
                <div class="p-strength__item">
                    <figure class="p-strength__img">
                        <img src="<?php bloginfo('template_url');?>/img/personal-evaluation-img1.jpg" alt="安心設計のイメージ">
                    </figure>
                    <div class="p-strength__content">
                        <div class="p-strength__head">
                            <div class="p-strength__label-wrap">
                            ...
                            <h3 class="p-strength__item-title">完全成功報酬型の安心設計</h3>
                        ...
                        <p class="p-strength__desc">
                            経済的な不安を抱えている時期だからこそ、安心してご相談いただけるよう、報酬は年金の受給が決定した際にお支払いいただく「完全成功報酬型」を採用しています（※一部事務手数料等を除く）。万が一、受給に至らなかった場合には報酬はいただきませんので、リスクなくお手続きを進めていただけます。
                        </p>
                    </div>
                </div>
            ...
            <div class="p-point__list">
                ...
                <div class="p-point__item">
                    <figure class="p-point__img">
                        <img src="<?php bloginfo('template_url');?>/img/flow-step-img2.jpg" alt="チェックのイメージ">
                    </figure>
                    <div class="p-point__content">
                        <div class="p-point__head">
                            ...
                            <h3 class="p-point__item-title">受給可能性を丁寧に見極める<br />事前チェック</h3>
                        ...
                        <p class="p-point__desc">
                            まずは現在の病状やこれまでの通院歴、保険料の納付状況を詳しくお伺いし、受給の可能性があるかどうかを無料で判定いたします。見込みのないまま無理に申請を勧めることはありません。専門家の確かな目で、最初の一歩を正しくガイドします。
                        </p>
                    </div>
                </div>
                ...
                <div class="p-point__item p-point__item--reverse">
                    <figure class="p-point__img">
                        <img src="<?php bloginfo('template_url');?>/img/data.jpg" alt="資料のイメージ">
                    </figure>
                    <div class="p-point__content">
                        <div class="p-point__head">
                            <div class="p-point__label-wrap">
                            ...
                            <h3 class="p-point__item-title">障害年金受給の壁を<br />熟知したサポート</h3>
                        ...
                        <p class="p-point__desc">
                            年間1,障害年金には「納付要件」「障害状態要件」「初診日要件」という3つの高い壁があります。私たちは多数の申請実績から、不支給になりやすいポイントや審査の傾向を熟知しています。プロが書類の隅々までチェックすることで、書類の不備による差し戻しや不支給のリスクを最小限に抑えます。
                        </p>
                    </div>
                </div>
    ...
    <section class="p-process">
        <div class="l-container">
            ...
            <div class="c-section-heading">
                ...
                <h2 class="c-section-heading__title-ja">/ 障害年金サポートの流れ</h2>
            </div>
                ...
                <li class="p-process__item">
                    ...
                    <div class="p-process__item-body">
                        ...
                        <p class="p-process__item-text">
                            監査の目的（IPO準備、M&現在の体調や日常生活での困りごと、初診日の時期、これまでの通院歴などを詳しく伺います。プライバシーに配慮した落ち着いた環境（またはオンライン）で、お客様のペースに合わせてお話を伺います。
                        </p>
                    </div>
                </li>
                <li class="p-process__item">
                    ...
                    <div class="p-process__item-body">
                        ...
                        <p class="p-process__item-text">
                            ヒアリング内容に基づき、年金事務所等で保険料の納付状況を確認し、受給の可能性を具体的に検討します。今後のスケジュール、必要な書類、費用体系について、ご納得いただけるまで分かりやすくご説明します。
                        </p>
                    </div>
                </li>
                <li class="p-process__item">
                    ...
                    <div class="p-process__item-body">
                        ...
                        <p class="p-process__item-text">
                            サポート内容に同意いただけましたら、正式にスタートとなります。速やかに医師への診断書作成依頼のサポートや、初診日の証明書類（受診状況等証明書）の取得、申立書のドラフト作成に取りかかります。
                        </p>
                    </div>
                </li>
                <li class="p-process__item">
                    ...
                    <div class="p-process__item-body">
                        ...
                        <p class="p-process__item-text">
                            全ての書類が揃い次第、年金事務所へ「裁定請求書」を提出します。提出後の役所からの問い合わせ対応も全てお任せください。支給が決定し、実際に年金が振り込まれるまで、責任を持ってあなたを支え続けます。
                        </p>
                    </div>
                </li>
            </ol>
                ...
                <dl class="p-faq__list">
                    ...
                    <div class="p-faq__item">
                        <dt class="p-faq__question">
                            ...
                            <p class="p-faq__text p-faq__text--bold">初回相談では何を確認しますか？</p>
                        </dt>
                        <dd class="p-faq__answer">
                            <span class="p-faq__icon p-faq__icon--a">A</span>
                            <p class="p-faq__text">
                                病歴や就労状況、保険料納付状況などを確認します。<br />受給の可能性を分かりやすくご説明します。
                            </p>
                        </dd>
                    </div>
                    ...
                    <div class="p-faq__item">
                        <dt class="p-faq__question">
                            <span class="p-faq__icon p-faq__icon--q">Q</span>
                            <p class="p-faq__text p-faq__text--bold">申請までどれくらい時間がかかりますか？</p>
                        </dt>
                        <dd class="p-faq__answer">
                            <span class="p-faq__icon p-faq__icon--a">A</span>
                            <p class="p-faq__text">
                                通常は2～3ヶ月程度です。<br />診断書の取得状況などにより前後します。
                            </p>
                        </dd>
                    </div>
                    ...
                    <div class="p-faq__item">
                        <dt class="p-faq__question">
                            <span class="p-faq__icon p-faq__icon--q">Q</span>
                            <p class="p-faq__text p-faq__text--bold">不支給だった場合も相談できますか？</p>
                        </dt>
                        <dd class="p-faq__answer">
                            <span class="p-faq__icon p-faq__icon--a">A</span>
                            <p class="p-faq__text">
                                はい、再申請や審査請求のご相談も可能です。<br />状況を整理し、今後の対応をご提案します。
                            </p>
                        </dd>
                    </div>
                </dl>
