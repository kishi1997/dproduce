        ...
        <div class="l-container">
            <div class="p-intro__inner">
                ...
                <p class="p-intro__lead">
                    従業員数が100名を超えると、人事労務の役割は「単なる事務」から「経営を支えるインフラ」へと変わります。
                    しかし、多くの企業様が「1名体制の社労士事務所」や「属人化した内製チーム」による限界<br />
                    レスポンスの遅れ、法改正への対応不足、そしてミスへの不安——に直面しているのが実情です。<br />
                    <br>
                    私たちD・プロデュースは、その「組織の壁」を突破するためのパートナーです。 一人の「先生」に頼るのではなく、プロフェッショナルな「組織」で貴社を支える。
                    創業期から拡大期、そして数千名規模の大企業までを支えてきた知見と、最新のデジタル技術を融合させ、貴社のさらなる成長を揺るぎないものにします。
                </p>
            </div>
        </div>
    </section>
            ...
            <div class="p-strength__list">
                ...
                <div class="p-strength__item">
                    ...
                    <div class="p-strength__content">
                        ...
                        <p class="p-strength__desc">
                            社労士業界で一般的な「1社1担当制」は、担当者の不在や退職がそのまま貴社のリスクに直結します。
                            D・プロデュースでは、お客様1社に対して役割の異なる5名の専任チームを編成。チャットツールで情報をリアルタイムに共有し、常に「誰かが即座に答えられる」体制を構築しています。属人化を徹底して排除し、止まることのない安定したバックオフィス運用をお約束します。
                        </p>
                    </div>
                </div>
                ...
                <div class="p-strength__item p-strength__item--reverse">
                    ...
                    <div class="p-strength__content">
                        ...
                        <p class="p-strength__desc">
                            私たちは、数名規模のスタートアップから、数千名規模の大企業まで、あらゆるフェーズの労務管理を経験してきました。
                            100名を超えると急増する入退社手続き、複雑な多拠点管理、そして膨大な給与計算。これらの課題を、最新のDXツールとこれまでの豊富な受託実績に裏打ちされたノウハウで、正確かつ効率的に処理します。貴社の規模がどれだけ拡大しても、柔軟に対応し続けるキャパシティがここにあります。
                        </p>
                    </div>
                </div>
                ...
                <div class="p-strength__item">
                    ...
                    <div class="p-strength__content">
                        ...
                        <p class="p-strength__desc">
                            目まぐるしく変わる労働法制。それを単なる「守るべきルール」として捉えるか、「組織をより良くするチャンス」として捉えるかで、企業の未来は変わります。
                            私たちは、法改正の内容を伝えるだけでなく、それが「貴社の現場にどう影響し、どう活用すべきか」を具体的に提言。定期的な勉強会の開催や独自のSRS診断を通じ、トラブルを未然に防ぎ、社員が安心して自走できる「強い組織」へのアップデートを支援します。
                        </p>
                    </div>
                </div>
            ...
            <div class="p-intro__inner">
                ...
                <div class="p-intro__btn-wrapper">
                    <div class="c-btn c-btn--outline">
                        <a href="<?php bloginfo('url'); ?>/reason/">選ばれる理由はこちら</a>
                    </div>
                </div>
            </div>
        </div>
